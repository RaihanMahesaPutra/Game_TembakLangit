var scenePlay = new Phaser.Class({
    ...
    update: function () {
        ...
        for (let i = 0; i < this.arrEnemies.length; i++) {
            // Cek apakah pesawat hero bertabrakan dengan musuh
            if (this.arrEnemies[i].active && 
                ...
                // Stop semua timer events
                this.time.removeAllEvents();
                
                // Buat efek ledakan di posisi hero
                let explosionEffect = this.add.particles('EfekLedakan');
                explosionEffect.setDepth(10);
                let explosionEmitter = explosionEffect.createEmitter({
                    x: this.heroShip.x,
                    y: this.heroShip.y,
                ...
                // Keluar dari loop untuk mencegah multiple collision
                break;
            }
        }
    }
